...
#ifndef MultiSEIR_model_hpp
#define MultiSEIR_model_hpp
 ...
 */
class MultiSEIR: public BaseCompartmentalModel {
public:
    
    MultiSEIR( uint nStrains, uint maxStrains );
    ...
    void setSimpleCrossReactiveSusceptibility( const double& sigma );
    void setMultiplicativeCrossReactiveSusceptibility( const double& sigma );
...
private:
    ...
    std::function<double (const Bird&, const StrainIdType&)> getCrossReactiveSusceptibility;
    double getCrossReactiveSusceptibilitySimple( const Bird& bird, const StrainIdType&, const double& sigma );
    double getCrossReactiveSusceptibilityMultiplicative( const Bird& bird, const StrainIdType&, const double& sigma );
